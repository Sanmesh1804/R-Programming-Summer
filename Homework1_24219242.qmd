...
-   Tooth length generally increases with **higher doses** of vitamin C.

-   Supplement type also appears to influence growth, especially at **lower doses**.

-   The `ToothGrowth` dataset provides a great example of visualizing experimental results using R.
